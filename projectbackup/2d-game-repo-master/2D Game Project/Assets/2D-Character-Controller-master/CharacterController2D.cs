...
public class CharacterController2D : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (m_Grounded = true && m_Rigidbody2D.velocity.x != 0) {
    ...
    public void Move(float move, bool crouch, bool jump, bool magic)
    {
    ...
    IEnumerator SpawnCloud () {
        while (m_Grounded = true) {
            Instantiate (dustCloud, GroundCheck.position, GroundCheck.rotation);
